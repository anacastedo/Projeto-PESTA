...
function outHTMLSectionsMCR(){
    ...
    //version
    htmlstr += '<div class="container mt-3">';
    htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3">Debug - Version</h5></div></div>';
    ...
    //Method Equations
    htmlstr += '<div class="container mt-3">';
    htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3" data-translate="_MeshNumberTitleMcr"></h5></div></div>';
    htmlstr += '<div class="container mt-3" id="meshEquations"></div>';

    //Meshes
    htmlstr += '<div class="container mt-3">';
    htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3" data-translate="_MeshTitleMCR"></h5></div></div>';
    ...
    //htmlstr += '<div class="container mt-3">';
    //htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3" data-translate="_resMesh"></h5></div></div>';
    //htmlstr += '<div class="container mt-3" id="resultsCurrentsMesh"></div></div>';

    // Results
    htmlstr += '<div class="container mt-3">';
    htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3" data-translate="_resultsMCR"></h5></div></div>';
