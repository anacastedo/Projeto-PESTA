 ...
 */
 function outEquationSystemMCM(simpEquations, strStep1, strStep2, strStep3){
    ...
    if(simpEquations.allVariableEq.length > 0){
        ...
        // STEP #2
        btnstr  = '<button class="btn collapsed bordertext-dark bg-light btn-info btn-sm float-right mt-1 mb-1 mr-1" ';
 ...
 */
 function outHTMLSectionsMCM(){
    ...
    //Method Equations
    htmlstr += '<div class="container mt-3">';
    htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3" data-translate="_MeshNumberTitle"></h5></div></div>';
    htmlstr += '<div class="container mt-3" id="meshEquations"></div>';

    //Meshes
    htmlstr += '<div class="container mt-3">';
    htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3" data-translate="_MeshTitle"></h5></div></div>';
    ...
    // Results
    htmlstr += '<div class="container mt-3">';
    htmlstr += '<div class="row bg-light rounded text-dark p-2"><h5 class="ml-3" data-translate="_resBranch"></h5></div></div>';
